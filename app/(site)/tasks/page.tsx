 ...
 *
 * Шесть карточек: по две загадки, фото-повтора и актива — пока в
 * пуле есть задания всех трёх типов. Кончился тип — его место
 * занимают другие, но карточек по-прежнему шесть. Список приходит
 * из `get_team_hand` — сервер сам следит за составом и пополняет
 * руку, когда карточка уходит. Всего пула здесь нет и быть не
 * должно: он и есть содержание квеста.
 *
