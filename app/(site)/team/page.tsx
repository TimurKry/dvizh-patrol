      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6">
        ...
        {!started && (
          <Card className="flex flex-col items-center gap-4 py-8 text-center">
            ...
            <p className="max-w-prose text-body text-stone">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="flex flex-col gap-1">
            <p className="text-caption text-stone">Баллы</p>
            <p className="text-heading tracking-[-1.32px] tabular-nums">
              {standing?.totalPoints ?? 0}
            </p>
            <p className="text-caption text-pebble">{pointsWord(standing?.totalPoints ?? 0)}</p>
          </Card>

          <Card className="flex flex-col gap-1">
            <p className="text-caption text-stone">Место</p>
            <p className="text-heading tracking-[-1.32px] tabular-nums">
              ...
              >
                <span className="text-body">
                  ...
                  {member.id === session.memberId && (
                    <span className="ml-2 text-caption text-stone">— это вы</span>
                  )}
                </span>
