  ...
  return (
    <div className="page-well flex max-w-3xl flex-col gap-6 py-8">
      <header>
        ...
        <h1 className="mt-2 text-headline">Настройки</h1>
      </header>

      {/* ═══ Состояние ══════════════════════════════════════ */}
      <Card className="flex flex-col gap-4 p-5">
        <h2 className="text-body-lg">Конфигурация</h2>
        ...
        <dl className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            [
              ...
              isAiConfigured() ? `включена, ${config.GEMINI_MODEL}` : 'ключ не задан — всё вручную',
            ],
      ...
      {/* ═══ Хранение фотографий ════════════════════════════ */}
      <Card className="flex flex-col gap-4 p-5">
        <h2 className="text-body-lg">Хранение фотографий</h2>
        ...
        <p className="text-body text-muted">
          Удаление стирает файлы из хранилища, но оставляет записи об отправках: журнал начислений и
          итоговый рейтинг не должны разъезжаться из-за уборки файлов.
        </p>
      ...
      <Card className="flex flex-col gap-3 p-5">
        <h2 className="text-body-lg">Если что-то пошло не так</h2>
        <ul className="flex flex-col gap-2 text-body text-muted">
          <li>
            <strong>Отказала автоматическая проверка.</strong> Выключите её в настройках мероприятия
            — все фотографии пойдут к вам. Квест не останавливается.
          </li>
          <li>
          ...
          <li>
            <strong>Нужно срочно разобрать очередь.</strong> «Всё — в ручную проверку» на странице
            проверки переведёт ожидающие отправки к вам.
          </li>
          <li>
