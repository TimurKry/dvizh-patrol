# Миграции 0008–0020: накатывание и откат

Тринадцать миграций, добавленных при доводке до V3 Mono Signal. Здесь
описано, что каждая делает, чем рискует, как её накатить и как
откатить.

Порядок отката — обратный порядку накатывания: `0020`, `0019`, `0018`, `0017`, `0016`, `0015`,
...
Все тринадцать применены к `mnoytybnurzsbvhyuuxb`: `0008`–`0012` 11.08.2026,
`0013`–`0017` — тогда же, `0018`–`0020` — 23.08.2026, все с
